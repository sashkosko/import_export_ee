...
if __name__ == '__main__':
    ...
    # і відмітити потрібні дні галочками. Потім натиснути кнопку шерингу і скопіювати url (до символа "?")
    ...
    # - Об'єднуємо з нашим датафреймом (з даними від розпорядника)
    # - Відсортовуємо і видаляємо дублікати
